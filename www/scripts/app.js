...
if (authBlock) {
  var auth = function auth() {
    var isAuth = document.querySelector('.j-account-auth');
    isAuth.addEventListener('click', function (event) {
      event.preventDefault();
    });
  };
