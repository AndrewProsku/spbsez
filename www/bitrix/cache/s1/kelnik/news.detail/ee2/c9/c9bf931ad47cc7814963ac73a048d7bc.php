...
$datecreate = '001599525976';
$dateexpire = '001599529576';
$ser_content = 'a:2:{s:7:"CONTENT";s:8331:"
<div class="l-news-single">
    ...
    <div class="l-news-single__title b-title"><h1>Круглый стол &laquo;Трансформация инновационной инфраструктуры промышленных территорий и&nbsp;ОЭЗ под новые тренды экономики&raquo;</h1></div>
    ...
    <div class="l-news-single__top-text">
                    ...
                    <div class="glide j-news-slider">
                        <div class="glide__track" data-glide-el="track">
                            <ul class="glide__slides">
                                    ...
                                    <img src="/upload/kelnik.news/51b/19112018_2.jpg" class="j-glide-slide-img" alt="">
        ...
        <div class="b-news-single-text b-news-single-text_theme_border">
            <p>Обменяться опытом и&nbsp;мнением о&nbsp;развитии промышленных территорий и&nbsp;оптимизации бизнес-процессов в&nbsp;условиях развития цифровой экономики планируется в&nbsp;рамках круглого стола «Трансформация инновационной инфраструктуры промышленных территорий и&nbsp;ОЭЗ под новые тренды экономики», который организовывает ОЭЗ. В&nbsp;формате дискуссии при участии представителей курирующих органов власти, российских и&nbsp;зарубежных ОЭЗ, а&nbsp;также экспертов рынка, будут подняты вопросы развития промышленной инфраструктуры крупных городов. </p>
 <p>
 Планируется также презентация проектных решений производственных площадей от&nbsp;ОЭЗ и&nbsp;обсуждение мер поддержки инновационного бизнеса в&nbsp;текущих экономических условиях. Итогом мероприятия станет разработка рекомендаций по&nbsp;развитию промышленной инфраструктуры ОЭЗ под реальные потребности бизнеса, которые будут направлены в&nbsp;соответствующие органы власти. </p>
 <p>
 Круглый стол состоится 29&nbsp;ноября в&nbsp;12:30&nbsp;на площадке КВЦ Экспофорум в&nbsp;рамках деловой программы <a href="https://www.facebook.com/spbinnoforum/?__tn__=K-R&eid=ARDi18OopdOFX_iIVwePOU_drV-Y_IXLZO2e0K7UexJTx39xsvbvoenV8vuS-l-Ut8tMZmgYpt0rIgyg&fref=mentions">Петербургский международный инновационный форум</a>.</p>        </div>
    </div>
...
";s:4:"VARS";a:2:{s:8:"arResult";a:6:{s:2:"ID";s:3:"126";s:4:"CODE";s:100:"kruglyy-stol-transformatsiya-innovatsionnoy-infrastruktury-promyshlennykh-territoriy-i-oez-pod-novye";s:4:"NAME";s:231:"Круглый стол &laquo;Трансформация инновационной инфраструктуры промышленных территорий и&nbsp;ОЭЗ под новые тренды экономики&raquo;";s:10:"SECTION_ID";s:1:"1";s:8:"SEO_TAGS";a:1:{s:5:"TITLE";s:231:"Круглый стол &laquo;Трансформация инновационной инфраструктуры промышленных территорий и&nbsp;ОЭЗ под новые тренды экономики&raquo;";}s:7:"SECTION";a:1:{s:4:"PATH";a:0:{}}}s:18:"templateCachedData";a:3:{s:9:"frameMode";N;s:12:"frameModeCtx";s:68:"/local/components/kelnik/news.detail/templates/news-oez/template.php";s:17:"__currentCounters";a:1:{s:16:"kelnik:site.info";i:1;}}}}';
return true;
?>