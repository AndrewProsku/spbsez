...
$datecreate = '001599556259';
$dateexpire = '001599559859';
$ser_content = 'a:2:{s:7:"CONTENT";s:7254:"
<div class="l-news-single">
    ...
    <div class="l-news-single__title b-title"><h1>Введены новые тарифы на услуги управляющей компании ОЭЗ «Санкт-Петербург»</h1></div>
    ...
    <div class="l-news-single__top-text">
        ...
        <div class="b-news-single-text b-news-single-text_theme_border">
            <p>
	 Управляющая компания АО «ОЭЗ «Санкт-Петербург» предлагает услуги для развития проектов резидентов.
</p>
<p>
	 С начала 2020 года для резидентов ОЭЗ «Санкт-Петербург» действуют новые тарифы на услуги управляющей компании, с полным перечнем которых вы можете ознакомиться <a href="https://www.spbsez.ru/Services.pdf">здесь</a>.
</p>
<p>
 <b><i>Управляющая компания предлагает услуги:</i></b>
</p>
<p>
	 - по эксплуатации тепловых сетей, сетей водоснабжения и водоотведения, электроснабжения, аренде транспорта, эксплуатационному обслуживанию объектов электросетевого хозяйства, зданий и сооружений;
</p>
<p>
	 - по сопровождению проектирования и строительства объектов резидентов на территории ОЭЗ, по строительному контролю, рассмотрению и согласованию проектной документации резидентов и арендаторов при переустройстве и/или перепланировке объектов аренды;
</p>
<p>
	 - по правовым и имущественным отношениям;
</p>
<p>
	 - по сопровождению и развитию проектов инвесторов (PR, работа со СМИ);
</p>
<p>
	 - в сфере информационных технологий и АСУ (размещение ИТ-оборудования, ИТ-поддержка);
</p>
<p>
	 Также управляющая компания предоставляет в аренду коммерческие помещения в бизнес-центрах класса «В+» на площадках «Нойдорф» (Петродворцовый район) и «Новоорловская» (Приморский район). Офисные помещения сдаются с отделкой, возможностью подключения к коммуникационным сетям, аренды переговорных комнат, конференц-залов и профессиональной уборки офисов. Возможна аренда парковочных мест.
</p>
<p>
	 Ознакомиться с полным перечнем услуг управляющей компании ОЭЗ «Санкт-Петербург» и оставить заявку на предоставление услуг вы можете <a href="https://www.spbsez.ru/services/"><span style="color: windowtext;">здесь</span></a>.
</p>        </div>
    </div>
...
";s:4:"VARS";a:2:{s:8:"arResult";a:6:{s:2:"ID";s:3:"262";s:4:"CODE";s:76:"vvedeny-novye-tarify-na-uslugi-upravlyayushchey-kompanii-oez-sankt-peterburg";s:4:"NAME";s:137:"Введены новые тарифы на услуги управляющей компании ОЭЗ «Санкт-Петербург»";s:10:"SECTION_ID";s:1:"1";s:8:"SEO_TAGS";a:1:{s:5:"TITLE";s:137:"Введены новые тарифы на услуги управляющей компании ОЭЗ «Санкт-Петербург»";}s:7:"SECTION";a:1:{s:4:"PATH";a:0:{}}}s:18:"templateCachedData";a:3:{s:9:"frameMode";N;s:12:"frameModeCtx";s:68:"/local/components/kelnik/news.detail/templates/news-oez/template.php";s:17:"__currentCounters";a:1:{s:16:"kelnik:site.info";i:1;}}}}';
return true;
?>