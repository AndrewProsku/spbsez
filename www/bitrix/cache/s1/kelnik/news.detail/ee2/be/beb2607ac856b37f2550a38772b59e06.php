...
$datecreate = '001599559050';
$dateexpire = '001599562650';
$ser_content = 'a:2:{s:7:"CONTENT";s:5903:"
<div class="l-news-single">
    ...
    <div class="l-news-single__title b-title"><h1>УК АО «ОЭЗ «Санкт-Петербург» приняла участие в Форуме «Инвестиции ОЭЗ»</h1></div>
    ...
    <div class="l-news-single__top-text">
        ...
        <div class="b-news-single-text b-news-single-text_theme_border">
            <p>
	 Генеральный директор АО «ОЭЗ «Санкт-Петербург» Тамара Рондалева приняла участие в форуме «Инвестиции в ОЭЗ», состоявшемся на территории ОЭЗ «Ворота Байкала».
</p>
<p>
	 Тамара Рондалева рассказала о необходимых изменениях в законодательство, регулирующее деятельность особых экономических зон России, влиянии пандемии на работу УК и резидентов, а также перспективах развития петербургской ОЭЗ.
</p>
<p>
	 «За 15 лет с момента появления проекта ОЭЗ назрела необходимость внесения изменений в законодательство для дальнейшего развития инструмента ОЭЗ.
</p>
<p>
	 Управляющая компания ОЭЗ «Санкт-Петербург», совместно с коллегами из других ОЭЗ, готова поддержать новый виток развития проекта своими рациональным предложениями по усовершенствованию инструмента и повышению его эффективности. Для этого управляющие компании накопили серьёзный опыт и имеют достаточный ресурс», - сказала Тамара Рондалева.
</p>        </div>
    </div>
...
";s:4:"VARS";a:2:{s:8:"arResult";a:6:{s:2:"ID";s:3:"294";s:4:"CODE";s:68:"uk-ao-oez-sankt-peterburg-prinyala-uchastie-v-forume-investitsii-oez";s:4:"NAME";s:130:"УК АО «ОЭЗ «Санкт-Петербург» приняла участие в Форуме «Инвестиции ОЭЗ»";s:10:"SECTION_ID";s:1:"1";s:8:"SEO_TAGS";a:1:{s:5:"TITLE";s:130:"УК АО «ОЭЗ «Санкт-Петербург» приняла участие в Форуме «Инвестиции ОЭЗ»";}s:7:"SECTION";a:1:{s:4:"PATH";a:0:{}}}s:18:"templateCachedData";a:3:{s:9:"frameMode";N;s:12:"frameModeCtx";s:68:"/local/components/kelnik/news.detail/templates/news-oez/template.php";s:17:"__currentCounters";a:1:{s:16:"kelnik:site.info";i:1;}}}}';
return true;
?>