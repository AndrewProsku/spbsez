...
$datecreate = '001599505009';
$dateexpire = '001599508609';
$ser_content = 'a:2:{s:7:"CONTENT";s:5312:"
<div class="l-news-single">
    ...
    <div class="l-news-single__title b-title"><h1>Приглашаем предпринимателей принять участие в разработке единого механизма развития территорий</h1></div>
    ...
    <div class="l-news-single__top-text">
        ...
        <div class="b-news-single-text b-news-single-text_theme_border">
            <p>
	 Минэкономразвития разрабатывает пакет законопроектов, который позволит создать единый механизм развития территорий и&nbsp;вывести инвестиционную привлекательность страны на&nbsp;новый уровень.
</p>
<p>
	Одна из&nbsp;ключевых задач единого механизма&nbsp;— создание максимально понятных, комфортных и&nbsp;прозрачных условий ведения бизнеса. Этого можно добиться за&nbsp;счет снятия административных барьеров, уменьшения количества бюрократических процедур, сокращения сроков рассмотрения документов и&nbsp;предоставления различных регуляторных послаблений.
</p>        </div>
    </div>
...
";s:4:"VARS";a:2:{s:8:"arResult";a:6:{s:2:"ID";s:3:"202";s:4:"CODE";s:98:"priglashaem-predprinimateley-prinyat-uchastie-v-razrabotke-edinogo-mekhanizma-razvitiya-territoriy";s:4:"NAME";s:179:"Приглашаем предпринимателей принять участие в разработке единого механизма развития территорий";s:10:"SECTION_ID";s:1:"1";s:8:"SEO_TAGS";a:1:{s:5:"TITLE";s:179:"Приглашаем предпринимателей принять участие в разработке единого механизма развития территорий";}s:7:"SECTION";a:1:{s:4:"PATH";a:0:{}}}s:18:"templateCachedData";a:3:{s:9:"frameMode";N;s:12:"frameModeCtx";s:68:"/local/components/kelnik/news.detail/templates/news-oez/template.php";s:17:"__currentCounters";a:1:{s:16:"kelnik:site.info";i:1;}}}}';
return true;
?>