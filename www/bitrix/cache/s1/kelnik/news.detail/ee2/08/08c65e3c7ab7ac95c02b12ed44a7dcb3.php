...
$datecreate = '001599557576';
$dateexpire = '001599561176';
$ser_content = 'a:2:{s:7:"CONTENT";s:6262:"
<div class="l-news-single">
    ...
    <div class="l-news-single__title b-title"><h1>Вторая очередь завода «Фармасинтез-Норд» будет введена в строй в 2020 году</h1></div>
    ...
    <div class="l-news-single__top-text">
        ...
        <div class="b-news-single-text b-news-single-text_theme_border">
            <b>В рамках визита городских СМИ на площадку «Новоорловская» Особой экономической зоны «Санкт-Петербург» состоялось посещение завода ГК «Фармасинтез» в Санкт-Петербурге.</b><br>
 ⠀<br>
 В настоящее время на «Фармасинтез-Норд» идет строительство второй очереди завода. Уже в следующем году на площадке начнется выпуск современных и эффективных противоопухолевых препаратов. Также будет разрабатываться принципиально новый&nbsp;препарат, аналогов которому нет в мире.<br>
 ⠀<br>
 «Данное предприятие соответствует требованиям по качеству не только российских стандартов, но еще и европейских, и американских. Стоит задача, чтобы предприятие работало уже в 2020 году. Стройка началась в текущем году, работы ведутся в сжатые сроки», — поделился генеральный директор «Фармасинтез-Норд» Михаил Квасников.<br>
 ⠀<br>
Следует отметить, что запуск первой очереди завода состоялся в 2017 году, общий объем инвестиций АО «Фармасинтез-Норд» на территории ОЭЗ составляет порядка 6,5 млрд рублей, из них 4 млрд рублей — на создание второй очереди. Завод будет производить 4 млн упаковок в год и обеспечит 450 новых рабочих мест.        </div>
    </div>
...
";s:4:"VARS";a:2:{s:8:"arResult";a:6:{s:2:"ID";s:3:"248";s:4:"CODE";s:73:"vtoraya-ochered-zavoda-farmasintez-nord-budet-vvedena-v-stroy-v-2020-godu";s:4:"NAME";s:133:"Вторая очередь завода «Фармасинтез-Норд» будет введена в строй в 2020 году";s:10:"SECTION_ID";s:1:"1";s:8:"SEO_TAGS";a:1:{s:5:"TITLE";s:133:"Вторая очередь завода «Фармасинтез-Норд» будет введена в строй в 2020 году";}s:7:"SECTION";a:1:{s:4:"PATH";a:0:{}}}s:18:"templateCachedData";a:3:{s:9:"frameMode";N;s:12:"frameModeCtx";s:68:"/local/components/kelnik/news.detail/templates/news-oez/template.php";s:17:"__currentCounters";a:1:{s:16:"kelnik:site.info";i:1;}}}}';
return true;
?>