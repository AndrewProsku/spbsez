...
$datecreate = '001599561323';
$dateexpire = '001599564923';
...
<div class="l-news-single">
    ...
    <div class="l-news-single__title b-title"><h1>Пролонгации преференций для ОЭЗ </h1></div>
    ...
    <div class="l-news-single__top-text">
        ...
        <div class="b-news-single-text b-news-single-text_theme_border">
            <p>Генеральный директор АО&nbsp;«Особая экономическая зона «Санкт-Петербург» Тамара Рондалева: «Мы&nbsp;поддерживаем пролонгацию по&nbsp;налогу на&nbsp;прибыль и&nbsp;особенно страховым взносам. Наши резиденты&nbsp;— высокотехнологичные компании с&nbsp;квалифицированными, дорогостоящими специалистами, уровень зарплат которых достаточно высокий. В&nbsp;связи с&nbsp;этим и&nbsp;страховые взносы работодателя составляют существенную затратную статью. Поэтому продление этой льготы&nbsp;— важный фактор экономической и&nbsp;финансовой эффективности резидентов нашей ОЭЗ. Условия ведения деятельности в&nbsp;инновационных ОЭЗ не&nbsp;должны быть менее выгодными, чем в&nbsp;других институтах развития экономики России».</p>
 <p>
 <a href="https://rg.ru/2018/08/14/reg-szfo/naskolko-effektivny-osobye-ekonomicheskie-zony-szfo.html?fbclid=IwAR29A2SXgydVCaOtuwjt3vyrecc5QQCoMnAAcNT1xYMYSHKkHrcA5TxukyE">Источник</a></p>        </div>
    </div>
...
";s:4:"VARS";a:2:{s:8:"arResult";a:6:{s:2:"ID";s:2:"73";s:4:"CODE";s:34:"prolongatsii-preferentsiy-dlya-oez";s:4:"NAME";s:60:"Пролонгации преференций для ОЭЗ ";s:10:"SECTION_ID";s:1:"1";s:8:"SEO_TAGS";a:1:{s:5:"TITLE";s:60:"Пролонгации преференций для ОЭЗ ";}s:7:"SECTION";a:1:{s:4:"PATH";a:0:{}}}s:18:"templateCachedData";a:3:{s:9:"frameMode";N;s:12:"frameModeCtx";s:68:"/local/components/kelnik/news.detail/templates/news-oez/template.php";s:17:"__currentCounters";a:1:{s:16:"kelnik:site.info";i:1;}}}}';
return true;
?>