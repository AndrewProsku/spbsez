...
$datecreate = '001599554924';
$dateexpire = '001599558524';
$ser_content = 'a:2:{s:7:"CONTENT";s:6327:"
<div class="l-news-single">
    ...
    <div class="l-news-single__title b-title"><h1>В ОЭЗ «Санкт-Петербург» появятся 4 новых резидента с общим объемом инвестиций более 10 млрд рублей</h1></div>
    ...
    <div class="l-news-single__top-text">
        ...
        <div class="b-news-single-text b-news-single-text_theme_border">
            <b>31&nbsp;мая 2019 года состоялось заседание Экспертного совета ОЭЗ «Санкт-Петербург», на&nbsp;котором были рассмотрены 4&nbsp;новых проекта, а&nbsp;также изменения в&nbsp;соглашения 2&nbsp;действующих резидентов. Общий объем заявленных инвестиций в&nbsp;проекты составляет 10,67 млрд рублей. </b><br>
 Экспертный совет рассмотрел заявки на&nbsp;предоставление статуса резидента ОЭЗ «Санкт-Петербург» следующим компаниям: ООО «АМТ», ООО «ЭмСиЭнЭс Полиуретан РУС», ООО «БИОГЕН» и&nbsp;ООО «НПЦ «ЛКТ». Еще две компании&nbsp;— действующие резиденты ОЭЗ «Санкт-Петербург»: ООО «Балтфарма» и&nbsp;ООО «ПФ&nbsp;«ЭЛКОН», представили экспертному совету корректировки текущих проектов в&nbsp;ОЭЗ. <br>
 <br>
 <b>Об&nbsp;ОЭЗ «Санкт-Петербург» </b>На&nbsp;сегодняшний день на&nbsp;территории особой экономической зоны технико-внедренческого типа (ОЭЗ ТВТ) в&nbsp;Санкт-Петербурге зарегистрировано в&nbsp;качестве резидентов 49&nbsp;компаний. ОЭЗ размещается на&nbsp;двух участках&nbsp;— «Нойдорф» (18,99&nbsp;га, пос. Стрельна, Петродворцовый район Санкт-Петербурга) и&nbsp;«Новоорловская» (163,33&nbsp;га, Приморский район Санкт-Петербурга). Режим ОЭЗ ТВТ «Санкт-Петербург» действует до&nbsp;2054&nbsp;года.        </div>
    </div>
...
";s:4:"VARS";a:2:{s:8:"arResult";a:6:{s:2:"ID";s:3:"210";s:4:"CODE";s:100:"v-oez-sankt-peterburg-poyavyatsya-4-novykh-rezidenta-s-obshchim-obemom-investitsiy-bolee-10-mlrd-rub";s:4:"NAME";s:178:"В ОЭЗ «Санкт-Петербург» появятся 4 новых резидента с общим объемом инвестиций более 10 млрд рублей";s:10:"SECTION_ID";s:1:"1";s:8:"SEO_TAGS";a:1:{s:5:"TITLE";s:178:"В ОЭЗ «Санкт-Петербург» появятся 4 новых резидента с общим объемом инвестиций более 10 млрд рублей";}s:7:"SECTION";a:1:{s:4:"PATH";a:0:{}}}s:18:"templateCachedData";a:3:{s:9:"frameMode";N;s:12:"frameModeCtx";s:68:"/local/components/kelnik/news.detail/templates/news-oez/template.php";s:17:"__currentCounters";a:1:{s:16:"kelnik:site.info";i:1;}}}}';
return true;
?>