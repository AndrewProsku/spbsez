...
$datecreate = '001599532839';
$dateexpire = '001599536439';
$ser_content = 'a:2:{s:7:"CONTENT";s:7377:"
<div class="l-news-single">
    ...
    <div class="l-news-single__title b-title"><h1>Минздрав России зарегистрировал препарат для лечения COVID-19, разработанный резидентом ОЭЗ "Санкт-Петербург"</h1></div>
    ...
    <div class="l-news-single__top-text">
                    ...
                    <div class="glide j-news-slider">
                        <div class="glide__track" data-glide-el="track">
                            <ul class="glide__slides">
                                    ...
                                    <img src="/upload/kelnik.news/280/covid-19.jpg" class="j-glide-slide-img" alt="">
        ...
        <div class="b-news-single-text b-news-single-text_theme_border">
            Министерство здравоохранения зарегистрировало препарат левилимаб компании BIOCAD для лечения COVID-19.<br>
 <br>
 Препарат показан пациентам с тяжелым течением заболевания, когда развивается цитокиновый шторм — избыточная воспалительная реакция организма на внедрение вируса, которая приводит к повреждению легочной ткани и тяжелому течению инфекции с возможным летальным исходом.<br>
 «Результаты клинического исследования препарата, инициированного 24 апреля, демонстрируют, что терапия левилимабом может позволить существенно снижать смертность среди пациентов с COVID-19, а следовательно, нагрузку на систему здравоохранения», — прокомментировал Дмитрий Морозов.<br>        </div>
    </div>
...
";s:4:"VARS";a:2:{s:8:"arResult";a:6:{s:2:"ID";s:3:"280";s:4:"CODE";s:100:"minzdrav-rossii-zaregistriroval-preparat-dlya-lecheniya-covid-19-razrabotannyy-rezidentom-oez-sankt-";s:4:"NAME";s:196:"Минздрав России зарегистрировал препарат для лечения COVID-19, разработанный резидентом ОЭЗ "Санкт-Петербург"";s:10:"SECTION_ID";s:1:"1";s:8:"SEO_TAGS";a:1:{s:5:"TITLE";s:196:"Минздрав России зарегистрировал препарат для лечения COVID-19, разработанный резидентом ОЭЗ "Санкт-Петербург"";}s:7:"SECTION";a:1:{s:4:"PATH";a:0:{}}}s:18:"templateCachedData";a:3:{s:9:"frameMode";N;s:12:"frameModeCtx";s:68:"/local/components/kelnik/news.detail/templates/news-oez/template.php";s:17:"__currentCounters";a:1:{s:16:"kelnik:site.info";i:1;}}}}';
return true;
?>