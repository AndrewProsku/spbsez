...
$datecreate = '001599557569';
$dateexpire = '001599561169';
$ser_content = 'a:2:{s:7:"CONTENT";s:5455:"
<div class="l-news-single">
    ...
    <div class="l-news-single__title b-title"><h1>Резиденты ОЭЗ «Санкт-Петербург» попали в рейтинг Forbes</h1></div>
    ...
    <div class="l-news-single__top-text">
        ...
        <div class="b-news-single-text b-news-single-text_theme_border">
            <p>
	 Forbes выпустил первый рейтинг «20 лучших фармкомпаний России». В него попали сразу несколько компаний, развивающих свой бизнес в ОЭЗ «Санкт-Петербург». Это два резидента зоны: на 2-м месте рейтинга находится ЗАО «Биокад» (объем выручки за 2019 год 24,1 млрд рублей), а на 9-м месте АО «Вертекс» (выручка 10,3 млрд рублей).
</p>
<p>
	 Компания «Фармасинтез» (16,1 млрд рублей выручка за 2019 год), занявшая 5 место в рейтинге, является материнской компанией резидента петербургской ОЭЗ – АО «Фармасинтез-Норд». Замыкает список ООО «Герофарм» (выручка 6,4 млрд рублей), чье R&amp;D-подразделение ЗАО «Фарм-Холдинг» также размещается в ОЭЗ Петербурга.
</p>
<p>
	 Поздравляем компании-победителей!
</p>
<p>
	 &nbsp;
</p>        </div>
...
";s:4:"VARS";a:2:{s:8:"arResult";a:6:{s:2:"ID";s:3:"293";s:4:"CODE";s:53:"rezidenty-oez-sankt-peterburg-popali-v-reyting-forbes";s:4:"NAME";s:97:"Резиденты ОЭЗ «Санкт-Петербург» попали в рейтинг Forbes";s:10:"SECTION_ID";s:1:"1";s:8:"SEO_TAGS";a:1:{s:5:"TITLE";s:97:"Резиденты ОЭЗ «Санкт-Петербург» попали в рейтинг Forbes";}s:7:"SECTION";a:1:{s:4:"PATH";a:0:{}}}s:18:"templateCachedData";a:3:{s:9:"frameMode";N;s:12:"frameModeCtx";s:68:"/local/components/kelnik/news.detail/templates/news-oez/template.php";s:17:"__currentCounters";a:1:{s:16:"kelnik:site.info";i:1;}}}}';
return true;
?>