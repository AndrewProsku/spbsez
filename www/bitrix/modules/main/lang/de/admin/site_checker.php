...
Sie müssen <a href=\"https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=71&LESSON_ID=7655&LESSON_PATH=6415.6420.3698.7655\" target=_blank>DNS konfigurieren</a>, damit Ihr Bitrix24 auch von außen erreichbar wird.";
...
$MESS["SC_STRLEN_FAIL_PHP56"] = "String-Funktionen arbeiten nicht korrekt. Das kan durch einen PHP 5.6 Fehler verursacht sein (<a href=\"https://bugs.php.net/bug.php?id=68644\" target=_blank>https://bugs.php.net/bug.php?id=68644</a>). Es wird empfohlen, eine ältere oder eine neuere Version von PHP zu nutzen.  ";
...
$MESS["SC_HELP_CHECK_SOCNET"] = "Um die Nachrichten aus den sozialen Netzwerken zu bekommen, muss das Modul <a href=\"http://www.bitrixsoft.com/company/blog/news/integration-with-social-networks.php\">Soziale Services</a> konfiguriert werden, und zwar so, dass für jeden Service, der genutzt wird, ein Authentifizierungsschlüssel angegeben werden soll.";
$MESS["SC_HELP_CHECK_REST"] = "Für Integration mit externen Apps und einigen Apps vom Marketplace ist das Modul \"rest\" erforderlich. Sie können Ihre Apps zu Bitrix24 hinzufügen, folgen Sie dafür diesen <a href=\"https://dev.1c-bitrix.ru/learning/course/?COURSE_ID=43&LESSON_ID=3568\" target=\"_blank\">Richtlinien</a>.";
...
$MESS["MAIN_SC_NO_ACCESS"] = "Der Server von Bitrix, Inc. ist nicht verfügbar. Aktualisierungen und Bitrix Cloud Services sind nicht verfügbar.";
...
$MESS["MAIN_SC_NO_PUSH_STREAM_VIDEO"] = "Das Modul nginx-push-stream wird aufgefordert, Videoanrufe durchzuführen, ist aber nicht korrekt konfiguriert.";
...
$MESS["MAIN_SC_NO_PULL_EXTERNAL"] = "Die Verbindung mit dem Intranet von außen war erfolgreich, aber der Port von nginx-push-stream zum Lesen von Nachrichten ist nicht verfügbar. Mobile Sofortnachrichten werden nicht verfügbar sein.";
