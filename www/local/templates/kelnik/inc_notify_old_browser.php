...
<div class="b-alert-old-browser is-hidden">
    <div class="b-alert-old-browser__content">
        ...
        <!--[if IE 8 ]><h2 class="b-alert-old-browser__title"><?= \Bitrix\Main\Localization\Loc::getMessage('KELNIK_TMPL_OLD_BROWSER_HEADER'); ?></h2><![endif]-->
        <!--[if IE 8 ]><div class="b-alert-old-browser__text"><p><?= \Bitrix\Main\Localization\Loc::getMessage('KELNIK_TMPL_OLD_BROWSER_BODY'); ?></p></div><![endif]-->
