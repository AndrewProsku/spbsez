...
$formBlocks = \Kelnik\Helpers\ArrayHelper::getValue($formConfig, \Kelnik\Report\Model\ReportFieldsTable::FORM_COMMON, []);
$i = 1;
    ...
    <section class="b-report-block">
        ...
        foreach ($block['fields'] as $field) {
            ...
            <div class="b-input-block">
                ...
                <div><input type="text" name="comment[<?= \Kelnik\Report\Model\ReportFieldsTable::FORM_COMMON; ?>][0][<?= $field['id']; ?>]" value="<?= $this->getComment($field['id']); ?>" placeholder="Комментарий"></div>
            </div>
            <?php
        }
        ?>
