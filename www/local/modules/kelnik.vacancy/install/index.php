...
class kelnik_vacancy extends CModule
{
    public $MODULE_ID = 'kelnik.vacancy';
    ...
    public function __construct()
    {
        ...
        $this->MODULE_NAME = Loc::getMessage('KELNIK_VACANCY_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('KELNIK_VACANCY_DESCRIPTION');
        $this->PARTNER_NAME = Loc::getMessage('KELNIK_VACANCY_PARTNER_NAME');
