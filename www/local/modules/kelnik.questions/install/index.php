...
class kelnik_questions extends CModule
{
    public $MODULE_ID = 'kelnik.questions';
    ...
    public function __construct()
    {
        ...
        $this->MODULE_NAME = Loc::getMessage('KELNIK_QUESTIONS_COMPLETE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('KELNIK_QUESTIONS_COMPLETE_DESCRIPTION');
        $this->PARTNER_NAME = Loc::getMessage('KELNIK_QUESTIONS_PARTNER_NAME');
