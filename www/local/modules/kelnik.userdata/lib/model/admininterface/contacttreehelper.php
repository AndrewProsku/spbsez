...
Loc::loadMessages(
    ...
    . '..' . DIRECTORY_SEPARATOR . 'contacttable.php'
);

class ContactTreeHelper extends AdminBaseHelper
{
    ...
    public function show()
    {
        ...
        echo '<td class="adm-list-table-cell"><div class="adm-list-table-cell-inner">' . Loc::getMessage('KELNIK_USERDATA_PHONE') . '</div></td>';
        echo '<td class="adm-list-table-cell"><div class="adm-list-table-cell-inner">' . Loc::getMessage('KELNIK_USERDATA_EMAIL') . '</div></td>';
        echo '<td class="adm-list-table-cell"><div class="adm-list-table-cell-inner">' . Loc::getMessage('KELNIK_USERDATA_POSITION') . '</div></td>';
    ...
    protected function prepareChild(array $data, $isChild = false): array
    {
        ...
        foreach ($data as $k => $val) {
            ...
            $data[$k] = [
                ...
                'menu' => '<a class="bx-core-popup-menu-item bx-core-popup-menu-item-default" href="' . ContactEditHelper::getUrl(['ID' => $val['ID']]) . '">' .
