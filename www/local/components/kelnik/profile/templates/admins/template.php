                                ...
                                <div class="b-select-accordion__list-item">
                                    <div class="b-form__checkbox">
                                        ...
                                        <input id="<?= $rowId; ?>"
                                                ...
                                                type="checkbox"
                                                value="1"
                                                name="<?= \Kelnik\Userdata\Profile\ProfileEnvelope::CAN_REPORT; ?>"
                                                <?php if($row[\Kelnik\Userdata\Profile\ProfileEnvelope::CAN_REPORT]): ?> checked<?php endif; ?>>
                                ...
                                <div class="b-select-accordion__list-item">
                                    <div class="b-form__checkbox">
                                        ...
                                        <input id="<?= $rowId; ?>"
                                                ...
                                                type="checkbox"
                                               value="1"
                                               name="<?= \Kelnik\Userdata\Profile\ProfileEnvelope::CAN_MSG; ?>"
                                               <?php if($row[\Kelnik\Userdata\Profile\ProfileEnvelope::CAN_MSG]): ?> checked<?php endif; ?>>
                                        <label for="<?= $rowId; ?>" class="b-checkbox-label">
                                            <span class="b-checkbox-box"><svg width="16" height="11" xmlns="http://www.w3.org/2000/svg"
                                                      viewBox="0 0 16 11">
                                                <defs>
                                ...
                                <div class="b-select-accordion__list-item">
                                    <div class="b-form__checkbox">
                                        ...
                                        <input id="<?= $rowId; ?>"
                                                ...
                                                type="checkbox"
                                                value="1"
                                                name="<?= \Kelnik\Userdata\Profile\ProfileEnvelope::CAN_REQUEST; ?>"
                                                <?php if($row[\Kelnik\Userdata\Profile\ProfileEnvelope::CAN_REQUEST]): ?> checked<?php endif; ?>>
                                        <label for="<?= $rowId; ?>" class="b-checkbox-label">
                                            <span class="b-checkbox-box"><svg width="16" height="11" xmlns="http://www.w3.org/2000/svg"
                                                      viewBox="0 0 16 11">
                                                    <defs>
