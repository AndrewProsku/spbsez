...
<div class="b-useful j-useful-main" data-action="/api/news/?sect=<?= $arParams['SECTION_ID']; ?>&compid=<?= $arParams['AJAX_COMPONENT_ID']; ?>&lang=<?= LANGUAGE_ID; ?>" data-method="post">
    <div class="b-useful__content j-useful-content">
        <?php foreach($arResult['ELEMENTS'] as $arItem): ?>
            <div class="b-useful__item j-useful-item">
                <div class="b-useful-item b-useful-item_gray_date">
    ...
    <div class="b-useful__load-more"<?php if(!$arResult['MORE']): ?> style="display:none;"<?php endif; ?>>
        <a href="#" class="button button_theme_gray button_icon_refresh j-useful-load-more">Загрузить еще статьи</a>
    </div>
</div>
