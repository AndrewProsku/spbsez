...
<div class="b-useful">
    ...
    <div class="b-useful__content">
        ...
        <div class="b-useful__item">
            <div class="b-useful__caption-wrap">
                <a href="<?= $arItem['DETAIL_PAGE_URL']; ?>" class="b-useful__caption b-link-line"><?= $arItem['NAME']; ?></a>
            </div>
            <div class="b-useful__text"><?= $arItem['TEXT_PREVIEW']; ?></div>
            <div class="b-useful__date">
                <span>
