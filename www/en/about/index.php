...
$APPLICATION->SetPageProperty('title', 'Special Economic Zone | SEZ');
?>
    ...
    <div class="l-about">
        ...
        <div class="l-home-plots j-home-plots" id="area">
